...
import ColumnMilestone from '@tempComponents/v2/molecules/ColumnMilestone';
import RightMenu from '@tempComponents/v2/molecules/RightMenu';
import TechTree from '@tempComponents/v2/molecules/TechTree';
// import MpTitle from '@tempComponents/v2//molecules/MpTitle';
import { totalStepsList, tagsDummy, memoContent, UniverseInfo } from '@tempComponents/v2/Dummy';
import Button from '@tempComponents/v2/atoms/Buttons';
import axios from 'axios';
import Modal, { useModal } from '@tempComponents/v2/molecules/Modal';
import SaveInvestmentUniverse from '@tempComponents/v2/template/SaveInvestmentUniverse';
import CustomTable, { TColumn, TRow } from '@tempComponents/v2/organisms/CustomTable';
        ...
        <div css={BTSContainerCss}>
          ...
          >
            ...
            <Button
              ...
              textCol={'#fff'}
              text={'+ Add'}
              onClick={() => openModalHandler('addIU')}
            />
            {openedModal == 'addIU' && isOpen && (
              <Modal closeModal={closeModal}>
                ...
                >
                  <span>
                    {/* 성재 Modal Filter */}
                    <SearchFilter filterLists={fakeData} onApply={(data) => console.log(data)} />
                    {columns && rows && (
                      <CustomTable
                        columns={columns} //columns Data Array
                        rows={rows} // Rows Data Array
                        ...
                        actions={[
                          {
                            icon: (
                              <Image width={23} height={23} src={`/img/taehyun/bx-trash-alt.png`} alt="bx-trash-alt" />
                            ),
                            tooltip: 'action1',
                            onClick: () => console.log('action1'),
                          },
          ...
          >
            ...
            <Button
              ...
              backCol={'#FFFFFF'}
              textCol={'#546A78'}
              text={'Save Investment Universe'}
              onClick={() => openModalHandler('saveIU')}
            />
...
export default Template_Asd_304;
