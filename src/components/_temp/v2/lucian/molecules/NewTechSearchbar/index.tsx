 ...
 */
const NewTechSearchbar = ({ width, height = 42, value, onChange, onSearch, withShadow, withClear }: SearchBarProps) => {
    ...
    <div css={[searchBarContainerWrap({ width, height, withShadow })]}>
      ...
      >
        ...
        <div css={searchIconWrapStyle} onClick={searchHandle}>
          <BiSearchAlt2 color='#2F3B43' size={24}/>
        </div>
...
export default NewTechSearchbar;
