...
import PfDiagnosisSidebarSubTitle from "@lucian2Components/molecules/PfDiagnosisSidebarSubTitle";
      ...
      <div css={[bodyInnerWrapCss]}>
        <div css={[bodyUpperWrap]}>
          <div css={[contentsWrap]}>
            {data.slice(0,-1).map((j,v) => <PfDiagnosisSidebarSubTitle key={j.id} item={j} icon={iconList[v].icon} onClickLayerHandler={onClickLayerHandler} clickedLayer={clickedLayer} />)}
          </div>
        </div>
