...
const rangeBarContainerWrap = () => css`
  ${inlineFlexColumnCenter};
  width: 100%;
...
const rangeBarContentsWrap = (props: {
  ...
  height: 142.56px;
  border: 0.5px solid ${props.theme.colors.primary6};
  margin-top: 8px;
  position: relative;
  border-radius: 4px;
`;

const arrowIconWrapStyle = () => css`
  position: absolute;
  top: -17.6px;
  left: 92px;
`;
