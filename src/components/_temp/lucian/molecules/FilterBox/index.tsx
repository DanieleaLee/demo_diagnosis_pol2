...
import Dropdown from "@lucianComponents/molecules/Dropdown";
...
interface Props {
  ...
  changeCheckedItemsState: (idx: number, checkedArr: string[]) => void;
  id: number;
  checkedItems: string[];
}

const filterBoxContainerWrap = () => css`
  padding-right: 10px;
`;
...
const FilterBox = ({
  ...
  return (
    <div css={filterBoxContainerWrap} ref={nodeRef}>
      <div
        css={css`
          ${flexColumnBase}
        `}
