...
import TextButtonNormal from './TextButtonNormal';
...
const TextButton = ({
  ...
  return (
    <Buttonable onClick={onClick} containerCss={flexCenter} {...props}>
      {left}
      <Typography.Base
...
export const Small = TextButtonSmall;
export const Normal = TextButtonNormal;
