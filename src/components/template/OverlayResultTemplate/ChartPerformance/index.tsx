...
const ChartPerformance = ({
  ...
  const onSelectDatebarHandler = (selectedId) => {
    const isTbData = tableData_.filter(
      (el, i) => el.id == selectedId && el.tb_data
    ).length
      ? true
      : false;
          ...
          >
            {lineData && (
              <PCLineChart2
                ...
                rowData={[
                  {
                    rowData: lineData["Original Portfolio"],
                    name: "Original Portfolio"
                  },
                  { rowData: lineData["Benchmark"], name: "Benchmark" },
                  {
                    rowData: lineData["Overlaid Portfolio1"],
                    name: "Overlaid Portfolio1"
                  },
                  {
                    rowData: lineData["Overlaid Portfolio2"],
                    name: "Overlaid Portfolio2"
                  },
                  {
                    rowData: lineData["Overlaid Portfolio3"],
                    name: "Overlaid Portfolio3"
                  },
                  {
                    rowData: lineData["Overlaid Portfolio4"],
